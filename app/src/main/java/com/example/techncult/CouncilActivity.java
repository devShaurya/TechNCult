...
public class CouncilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(CouncilActivity.this);
        ...
        councilAdapter=new CouncilAdapter(councilList,CouncilActivity.this);
        ActionBarDrawerToggle actionBarDrawerToggle = new ActionBarDrawerToggle(CouncilActivity.this, drawerLayout,
                toolbar,
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(CouncilActivity.this,2));

        db.collection(council).whereEqualTo("club","1").get().addOnCompleteListener(
                CouncilActivity.this,
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    case R.id.home:
                        intent=new Intent(CouncilActivity.this,MainActivity.class);
                        intent.putExtra("Council","Tech Council");
                        startActivity(intent);
                        break;
                    case R.id.techcouncil:
                        if(council.equals("Cultural Council")) {
                        intent = new Intent(CouncilActivity.this, CouncilActivity.class);
                        intent.putExtra("Council", "Tech Council");
                        startActivity(intent);
                    }
                        break;
                    case R.id.cultcouncil:
                        if(council.equals("Technical Council")) {
                            intent = new Intent(CouncilActivity.this, CouncilActivity.class);
                    ...
                    case R.id.notification:
                        intent=new Intent(CouncilActivity.this,Notification.class);
                        startActivity(intent);
                        break;
                    case R.id.dev:
                        intent=new Intent(CouncilActivity.this,Developers.class);
                        startActivity(intent);
                        break;
                }
