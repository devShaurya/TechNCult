...
public class TechCouncilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(TechCouncilActivity.this);
        ...
        councilAdapter=new CouncilAdapter(councilList, TechCouncilActivity.this);
        ActionBarDrawerToggle actionBarDrawerToggle = new ActionBarDrawerToggle(TechCouncilActivity.this, drawerLayout,
                toolbar,
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(TechCouncilActivity.this,2));

        db.collection(council).whereEqualTo("club","1").get().addOnCompleteListener(
                TechCouncilActivity.this,
        ...
        db.collection(council).whereEqualTo("club","0").get().addOnCompleteListener(
                ...
                new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        Glide.with(TechCouncilActivity.this).load(
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    case R.id.home:
                        intent=new Intent(TechCouncilActivity.this,MainActivity.class);
                        intent.putExtra("Council","Tech Council");
                        startActivity(intent);
                        break;
                    case R.id.cultcouncil:
                            intent = new Intent(TechCouncilActivity.this, CultCouncilActivity.class);
                    ...
                    case R.id.notification:
                        intent=new Intent(TechCouncilActivity.this,Notification.class);
                        startActivity(intent);
                        break;
                    case R.id.dev:
                        intent=new Intent(TechCouncilActivity.this,Developers.class);
                        startActivity(intent);
                        break;
                }
